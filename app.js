...
function renderDashboard(c){
  ...
  data.forEach(d=>{
    ...
    h+=`<tr><td class="col-b">${esc(d.b.name)}</td><td class="num">${b2}</td>
      ...
      <td class="col-now"><div class="now-wrap"><span class="now-num num">${ca.total}</span><span class="now-ca"><span class="ca-line"><span class="ca-chess">CHESS ${ca.chess}</span>${caPct(ca.chess,ca.total)}</span><span class="ca-line"><span class="ca-ace">ACE ${ca.ace}</span>${caPct(ca.ace,ca.total)}</span></span></div></td>
  ...
  h+=`<tr class="sum"><td class="col-b">합계</td><td class="num">${fmt(baseTot)}</td>
    ...
    <td class="col-now"><div class="now-wrap"><span class="now-num num">${fmt(caAct.total)}</span><span class="now-ca"><span class="ca-line"><span class="ca-chess">CHESS ${caAct.chess}</span>${caPct(caAct.chess,caAct.total)}</span><span class="ca-line"><span class="ca-ace">ACE ${caAct.ace}</span>${caPct(caAct.ace,caAct.total)}</span></span></div></td>
